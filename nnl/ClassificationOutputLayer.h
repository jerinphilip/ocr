...
#ifndef _INCLUDED_ClassificationOutputLayer_h  
#define _INCLUDED_ClassificationOutputLayer_h  

#include "OutputLayer.h"
#include "InputConnsImpl.h"
#include "Helpers.h"

class ClassificationOutputLayer: 
		public OutputLayer,
...
public:
	...
	ClassificationOutputLayer(const string& name, int numClasses, const vector<string>& labels, vector<string>& criteria);
